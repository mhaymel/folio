...
### R-004a: Interfaces must be package-private by default
...
### R-004b: Interfaces must follow single responsibility
...
### R-004c: Interfaces should stay small and cohesive
