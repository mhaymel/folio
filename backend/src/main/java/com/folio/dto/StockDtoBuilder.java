...
public final class StockDtoBuilder {
    ...
    public StockDtoBuilder isin(String isin) { this.isin = isin; return this; }
    ...
    public StockDtoBuilder totalShares(Double totalShares) { this.totalShares = totalShares; return this; }
    ...
    public StockDto build() {
        ...
        s.setTotalShares(totalShares); s.setAvgEntryPrice(avgEntryPrice);
