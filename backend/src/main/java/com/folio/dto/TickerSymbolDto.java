...
public final class TickerSymbolDto {
    ...
    public TickerSymbolDto(Isin isin, String tickerSymbol, String name) {
        this.isin = isin;
        this.tickerSymbol = TickerSymbolFactory.of(tickerSymbol).orElse(null);
        this.name = name;
    }
    ...
    public void setTickerSymbol(String tickerSymbol) { this.tickerSymbol = TickerSymbolFactory.of(tickerSymbol).orElse(null); }
